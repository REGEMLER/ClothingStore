...
const ProductPage = () => {
    ...
    const raiment = [
        {id: card.id+11, title: card.title, size: "40-60", price: "150", image: card.image},
        {id: card.id+12, title: card.title, size: "40-60", price: "200", image: card.image},
        {id: card.id+13, title: card.title, size: "40-60", price: "250", image: card.image},
        {id: card.id+14, title: card.title, size: "40-60", price: "350", image: card.image},
        {id: card.id+15, title: card.title, size: "40-60", price: "450", image: card.image},
        {id: card.id+16, title: card.title, size: "40-60", price: "500", image: card.image},
        {id: card.id+17, title: card.title, size: "40-60", price: "550", image: card.image},
        {id: card.id+18, title: card.title, size: "40-60", price: "650", image: card.image},
        {id: card.id+19, title: card.title, size: "40-60", price: "1000",image: card.image},
    ];
