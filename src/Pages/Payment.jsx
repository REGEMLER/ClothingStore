...
const Payment = () => {
    ...
    return(
        ...
        <Container className="p-4" style={{overflow: "hidden"}}>
            <Row onClick={handleShow} className="align-items-center">
       ...
       <Modal.Header closeButton><Modal.Title>Оплата заказа</Modal.Title></Modal.Header>
        <Modal.Body>
          <Form>
            <Form.Group
              className="mb-3"
              controlId="exampleForm.ControlTextarea1">
              <Form.Label>Введите номер вышей карты</Form.Label>
