    ...
    return(
        <section>
            ...
            <div className="questionsBtns">
                <button onClick={handleShow}>Задать вопрос</button>
                <button onClick={callShow}>Позвонить</button>
            </div>
            </div>
            <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Что Вас интересует?</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={succeesShow1}>
            Отправить
          </Button>
        </Modal.Footer>
      </Modal>
      <Modal show={call} onHide={callClose}>
            <Modal.Header closeButton>
                <Modal.Title>Позвонить</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Form>
            ...
            <Modal.Footer>
          <Button variant="secondary" onClick={callClose}>
            Отмена
          </Button>
          <Button variant="primary" onClick={succeesShow2}>
            Отправить
          </Button>
        </Modal.Footer>
        </Modal>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={succesClose}>
            ОК
          </Button>
        </Modal.Footer>
      </Modal>
